...
from services.stock_service import get_stocks_data, get_top_gainers, get_top_losers, get_stock_detail_data, get_stock_historical_data
...
def get_stock_detail(symbol):
    stock_detail = get_stock_detail_data(symbol)
