...
import { getYearGainers } from '../../api/stocks'; // Define this function in your API file
...
const YearGainers = () => {
  ...
  return <StockTable fetchStocks={getYearGainers} columns={columns} getChangeColor={getChangeColor} />;
};

export default YearGainers;
